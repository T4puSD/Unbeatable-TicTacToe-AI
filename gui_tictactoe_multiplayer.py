...
def check_win(board,curr_player,game_round):
    ...
    #diagonal
    if(board[0][0] == board[1][1] == board[2][2] and board[0][0] == board[1][1] == board[2][2] != ' ' or board[0][2] == board[1][1] == board[2][0]  and board[0][2] == board[1][1] == board[2][0] != ' ' ):
        flag = True
    if(flag):
...
label_for_player1_name = tk.Label(top_frame,text='Enter Player 1 Name')
label_for_player1_name.pack()
player1_name = tk.Entry(top_frame)
player1_name.pack()
label_for_player2_name = tk.Label(top_frame,text='Enter Player 2 Name')
label_for_player2_name.pack()
